...
public class FederatedCatalogApiExtension implements ServiceExtension {
    ...
    public static final String NAME = "Management API: Federated Catalog Query";
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        webService.registerResource(ApiContext.MANAGEMENT, new FederatedCatalogApiV3Controller(queryService, managementApiTransformerRegistry, validatorRegistry));
        ...
        webService.registerResource(ApiContext.MANAGEMENT, new FederatedCatalogApiV4Controller(queryService, managementApiTransformerRegistry, validatorRegistry));
        webService.registerDynamicResource(ApiContext.MANAGEMENT, FederatedCatalogApiV4Controller.class,
