...
public class FederatedCatalogApiV3ControllerTest extends BaseFederatedCatalogApiControllerTest {

    @Override
    protected Object controller() {
        return new FederatedCatalogApiV3Controller(queryService, transformerRegistry, validatorRegistry);
    }
